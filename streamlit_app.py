...
def main():
    ...
    st.markdown(
        ...
        <div class="hero-section">
            <h1 style='color: #D4AF37; margin-bottom: 0.5rem; font-style: italic; font-family: "Dancing Script", cursive; font-weight: 700; font-size: 5rem; letter-spacing: 2px;'>Le Mariage</h1>
